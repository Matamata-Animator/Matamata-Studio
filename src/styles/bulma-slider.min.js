              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    e = this.element.getAttribute("min")
                      ? this.element.getAttribute("min")
                      : 0;
                    var r =
                      (this.element.value - e) /
                      (this.element.getAttribute("max") - e);
                ...
                },
                {
                  ...
                  value: function () {
                    this.output &&
                      this.element.addEventListener("input", this[l], !1);
                  },
                },
                {
                  key: l,
                    ...
                    return (
                      [].forEach.call(t, function (e) {
                        if (void 0 === e[n.constructor.name]) {
                          var t = new o(e, r);
                          (e[n.constructor.name] = t), i.push(t);
                      ...
                      o ||
                        ...
                        Array.isArray(a)
                          ? (a.forEach(function (e) {
                            ...
                            l >= a.length && (s = !0))
                          : (s = !0)),
                        s && (e.once && (u[t] = null), e.callback(r));
                    });
                    -1 !== u.indexOf(null);
